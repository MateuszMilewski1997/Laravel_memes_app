        ...
        <div class="form-group mt-5">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div><img style="width: 80%; height: auto;" class="form-img" id="blah" src="#" alt="your image" />
                    </div>
                    <div class="input-group mt-4">
                        ...
                        <div class="custom-file mt-4">
                            <input name="cover_image" type="file" onchange="readURL(this)" class="custom-file-input"
                ...
                <div class="col-md-6 col-sm-12">
                    <h5>Old photo</h5>
                    <img src="{{ asset('storage/cover_images/'.$meme->photoPath) }}"
